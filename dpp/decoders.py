...
def LogNormMix(config, n_components=64, hypernet_hidden_sizes=None, scale_init=1.0, shift_init=0.0, trainable_affine=False, use_sofplus=False, **kwargs):
    """Mixture of log-normal distributions.

    Denoted as 'LogNormMix' in our paper.
    Defined in Section 3.2, 3.3 and Appendix D.2.
    """
    if hypernet_hidden_sizes is None:
...
def Exponential(config, n_components=64, hypernet_hidden_sizes=None, scale_init=1.0, shift_init=0.0, trainable_affine=False, use_sofplus=False, **kwargs):
