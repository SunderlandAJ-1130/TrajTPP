...
parser.add_argument('--num_classes', type=int, default=112)
...
parser.add_argument('--dataset_name', type=str, default='./dataset/CS trajectory')
...
if __name__ == '__main__':
    ...
    log_path = f'./log/{args.log_dir}-{args.time_threshold}-{args.trip_threshold}/'
